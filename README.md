# E-commerce tamplate
E-commerce sencillo como presentacion de trabajo final del curso de ReactJS. Se podra visualizar los productos con sus detalles para poder agregarlos a un carro de compra en linea. Tanto los valores de las ordenes de compras generadas, como los detalles de los productos se almacenan en Firebase
